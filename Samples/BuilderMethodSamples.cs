...
namespace SampleQueries.Samples
{
    ...
    class BuilderMethodSamples : NorthwindBasedSample
    {
        ...
        {
            var query = context.Categories.Top("10");
        ...
        {
            int topNumber = 10;
            var query = context.Categories.Top("@count", new ObjectParameter("count", topNumber));
        ...
        {
            var query = context.Categories.First();
        ...
        {
            ObjectDumper.Write(context.Categories.Where("it.CategoryName = 'none'").FirstOrDefault());
        }
        ...
        {
            ObjectDumper.Write(context.Employees.Select(c => new
            {
                IntValue = (int)1,
                ShortValue = (short)2,
                LongValue = (long)3,
        ...
        {
            ObjectDumper.Write(context.Employees.Select("true,false").Top("1"));
        }
        ...
        {
            ObjectDumper.Write(context.Employees.Select("DATETIME'2008-01-01 23:59:59'").Top("1"));
        }
        ...
        {
            var query = context.Orders.Include("OrderDetails").Top("1");
        ...
        {
            var query = context.Orders.Top("5").Execute(MergeOption.NoTracking);
        ...
        {
            var startQuery = context.Orders.Top("5");
            // we update the OrderDate
            ...
            var query = context.Orders.Top("5").Execute(MergeOption.AppendOnly);
        ...
        public void ObjectServicesOC3()
        {
            ...
            var query = context.Orders.Top("5").Execute(MergeOption.OverwriteChanges);
        ...
        public void ObjectServicesOC4()
        {
            ...
            var query = context.Orders.Top("5").Execute(MergeOption.PreserveChanges);
            // note that the OrderDate is still the client updated value
            ObjectDumper.Write(query,1);
        }
